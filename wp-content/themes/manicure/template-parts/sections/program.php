<section class="section program" id="program">
    ...
    <div class="container-fluid">
        <div class="program_content">
            ...
            <!--                <div class="program_subtitle shadow-text--light">-->
            <?php //the_field('program-subtitle') ?><!--</div>-->
            <div class="program_subtitle shadow-text--light">
                <p style="max-width: 850px; color: #000;">Полный курс Обучения — <span
                            style="color: #8400ff; font-weight: 900">156 часов!</span><br>
                    <span style="color: #f03866;font-weight: 900">4 Недели Интенсива!</span></p>
                <p style="max-width: 700px;color: #000;">Диплом! Трудоустройство!</p>
                <p style="max-width: 500px;color: #000;">Без скрытых доплат!</p>
            </div>
            <!--            --><?php //endif; ?>
                                    ...
                                    <?php if (get_sub_field('program_popup_link')): ?>
                                        <div class="program_btn ">
                                            <a href="#popup<?php echo $count; ?>"
                                               class="js-pop-up btn program_link"><?php the_sub_field('program_popup_link'); ?></a>
                                        </div>
                                    <?php endif; ?>
            ...
            <div class="action_form">
                <?php echo do_shortcode(get_field('program-short')) ?>
            </div>
        </div>
    </div>
</section>
